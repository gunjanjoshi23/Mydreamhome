...
const MyTestimonials = () => {
    ...
    useEffect(() => {
        fetch('http://localhost:5500/api/mytestimonials', { credentials: 'include' })
            .then(res => res.json())
            .then(data => {
    ...
    return (
        <div style={{ fontFamily: 'Arial, sans-serif', background: '#f9f9f9', minHeight: '100vh',     paddingTop: '20px',
    marginTop: '100px',backgroundColor:"#CBAD7F"
 }}>
            <Header />
